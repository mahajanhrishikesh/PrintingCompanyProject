...
INSERT INTO `job_card` (`card_id`, `name`, `gsm`, `length`, `width`, `num_of_cards`, `cost`) VALUES
(1, 'gloss_paper', 60, 20, 30, 10, 15),
(2, 'gloss_card', 60, 20, 30, 10, 25),
(3, 'gloss_card', 60, 20, 30, 10, 25),
(4, 'gloss_card', 60, 20, 30, 10, 25),
(5, 'gloss_card', 60, 20, 30, 10, 25),
(6, 'gloss_card', 60, 20, 30, 10, 25);
...
--
ALTER TABLE `job_card`
  MODIFY `card_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
